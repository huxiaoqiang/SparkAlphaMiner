...
object Util {
  ...
  //parse Xes Log generated by plg(Process Log Generator)
  def parseXesLogFromHDFS(sqlContext: SQLContext, filePath: String): RDD[Array[String]] = {
    //load log file
    val list = Array(filePath)
